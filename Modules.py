...
def draw_board_characs(screen, gs, rec_width, rec_height, rows, columns):
...
There was a tie between the two teams.'''
      ...
      lbl = Label(win_window, text = txt, bg = '#a28938', fg = '#88001b', font = ('Brush Script Std', 16))
      lbl.place(relx = 0.5, rely = 0.5, anchor = CENTER)

      menu_btn = Button(win_window, text = 'Menu', command = destroyed, bg = '#7e6b26', fg = '#e7d789', font = ('Brush Script Std', 16))
...
1 step on other moves & captures diagonally'''
      ...
      # Rules
      label1 = Label(rules, text = rules_txt, bg = '#a28938', fg = 'black', font = ('Brush Script Std', 11))
      label1.place(relx = 0.5, rely = 0.42, anchor = CENTER)

      label2 = Label(rules, text = rules_hd, bg = '#a28938', fg = 'black', font = ('Brush Script Std', 14, 'bold'))
      label2.place(relx = 0.33, rely = 0.32, anchor = CENTER)

      # Properties
      label3 = Label(rules, text = prop_txt, bg = '#a28938', fg = 'black', font = ('Brush Script Std', 12))
      label3.place(relx = 0.53, rely = 0.58, anchor = CENTER)

      label4 = Label(rules, text = prop_hd, bg = '#a28938', fg = 'black', font = ('Brush Script Std', 14, 'bold'))
      label4.place(relx = 0.3, rely = 0.5, anchor = CENTER)

      # Moves
      label5 = Label(rules, text = move_txt, bg = '#a28938', fg = 'black', font = ('Brush Script Std', 12))
      label5.place(relx = 0.5, rely = 0.79, anchor = CENTER)

      label6 = Label(rules, text = move_hd, bg = '#a28938', fg = 'black', font = ('Brush Script Std', 14, 'bold'))
      label6.place(relx = 0.29, rely = 0.7, anchor = CENTER)

      # Back to menu
      back_btn=Button(rules, text = 'BACK', command = back_to_menu, bg = '#7e6b26', fg = 'black', font = ('Brush Script Std', 16, 'bold'))
